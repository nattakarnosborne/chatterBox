...
// this sweet alert is form opensource project
...
open class SweetAlert: UIViewController {
    ...
    fileprivate func setupSubTextField(){
    
        subTextField.placeholder = "Enter your email"
        subTextField.textAlignment = .left
        subTextField.font = UIFont(name: kFont, size:10)
        subTextField.textColor = UIColor.colorFromRGB(0x797979)
        subTextField.clearButtonMode = .whileEditing
    ...
    @discardableResult func showAlert(_ title: String) -> SweetAlert {
        self.showAlert(title, subTitle: nil, style: .none)
        return self
    }
    
    @discardableResult func showAlert(_ title: String, subTitle: String?, style: AlertStyle) -> SweetAlert {
        self.showAlert(title, subTitle: subTitle, style: style, buttonTitle: "OK")
        return self

    }

    @discardableResult func showAlert(_ title: String, subTitle: String?, style: AlertStyle,buttonTitle: String, action: ((_ isOtherButton: Bool) -> Void)? = nil) -> SweetAlert {
        self.showAlert(title, subTitle: subTitle, style: style, buttonTitle: buttonTitle,buttonColor: UIColor.colorFromRGB(0xAEDEF4))
        userAction = action
        return self
    }
    
    @discardableResult func showAlert(_ title: String, subTitle: String?, style: AlertStyle,buttonTitle: String,buttonColor: UIColor,action: ((_ isOtherButton: Bool) -> Void)? = nil) -> SweetAlert {
